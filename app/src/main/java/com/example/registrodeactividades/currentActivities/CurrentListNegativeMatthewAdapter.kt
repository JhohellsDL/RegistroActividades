...
class CurrentListNegativeMatthewAdapter(
...
) : ListAdapter<AccionNegativaMatthew, CurrentListNegativeMatthewAdapter.ActividadesNegativasViewHolder>(
    ...
    class AccionNegativaDiffCallback :
        ...
        override fun areItemsTheSame(
            oldItem: AccionNegativaMatthew,
            newItem: AccionNegativaMatthew
        ): Boolean {
